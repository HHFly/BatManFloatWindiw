...
public class CoreService extends Service {
        ...
        protected List<AppProcessInfo> doInBackground(Void... params) {
            ...
            for (ActivityManager.RunningAppProcessInfo appProcessInfo : appProcessList) {
                ...
                try {
                    ...
                    if ((appInfo.flags & ApplicationInfo.FLAG_SYSTEM) != 0|| !FilterAppUtils.filter(appInfo.packageName)) {
    ...
    public void killBackgroundProcesses(String processName) {
        // mIsScanning = true;
        Log.d(TAG, "killBackgroundProcesses: " +processName);
                ...
                for (ActivityManager.RunningAppProcessInfo appProcessInfo : appProcessList) {
                    ...
                    try {
                        ...
                        if ((appInfo.flags & ApplicationInfo.FLAG_SYSTEM) != 0|| !FilterAppUtils.filter(appInfo.packageName)) {
                            ...
                            killBackgroundProcesses(appInfo.processName);
